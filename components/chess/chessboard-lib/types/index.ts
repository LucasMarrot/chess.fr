...
export type CustomSquareRenderer = FC<CustomSquareProps> | keyof any;
...
export type ChessboardProps = {
   ...
   * @default { backgroundColor: boardWoodDark token }
   */
   ...
   * @default { boxShadow: inset with light token alpha }
   */
  customDropSquareStyle?: Record<string, string | number>;
  /**
   * Custom light square style object.
   * @default { backgroundColor: boardWoodLight token }
   */
